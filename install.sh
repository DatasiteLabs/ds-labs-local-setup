...
ansible-pull --url https://github.com/DatasiteLabs/ds-labs-local-setup -c main --directory "${__dir}/ds-labs-local-setup" --inventory "${__dir}/ds-labs-local-setup/hosts"
